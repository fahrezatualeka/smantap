...
class LaporanPiutangExport implements FromCollection, WithHeadings, WithEvents
{
    public function collection()
    {
        ...
        return $laporanPiutang->map(function ($piutang, $index) {
            return [
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('A1', 'Laporan Piutang Pajak Pemerintah Kota Ambon'); // Menetapkan judul
                ...
                $laporanPiutang = $this->collection();  // Ambil data yang sudah dimapping
