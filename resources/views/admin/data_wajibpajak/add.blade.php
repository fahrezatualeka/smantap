        ...
        <div class="box">
            <div class="box-header">
                ...
                <div class="pull-right">
                    <a href="{{ url('data_wajibpajak') }}" class="btn btn-info">
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-4 col-md-offset-4">
                        <form id="wpForm" action="{{ route('admin.data_wajibpajak.store') }}" method="post">
                            @csrf
                            ...
                            {{-- <div class="form-group">
                                ...
                                <input type="text" name="jumlah_piutang" id="jumlah_piutang" class="form-control" value="{{ old('jumlah_piutang') }}">
                            </div> --}}
