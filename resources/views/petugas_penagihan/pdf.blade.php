...
<head>
    ...
    <title>Data Penagihan Pajak Pemerintah Kota Ambon</title>
    <style>
        body {
...
<body>
    <h2>
        {{-- Data Penagihan Pajak Pemerintah Kota Ambon, Zonasi {{ $zonasi }} --}}
        Data Penagihan Pajak Pemerintah Kota Ambon
    </h2>
    <table>
        <thead>
            <tr>
